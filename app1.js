...
data.map((item) => {
  ...
  <div class="bg-image hover-zoom ripple ripple-surface ripple-surface-light"
   data-mdb-ripple-color="light">
    <img src=${item.image}
      class="card-img-top" alt="Laptop"  height = "350px"/>
  </div>
    <div class="card-body d-flex flex-column justify-content-evenly">
      ...
      <div class="d-flex justify-content-between mb-3">
        <h5 class="mb-0">${stringModify(item.title)}</h5>
        <h5 class="text-dark mb-0">$${item.price}</h5>
      </div>

      <div class="d-flex justify-content-between mb-2">
        <p class="text-muted mb-0">Available: <span class="fw-bold">${item.rating.count}</span></p>
        <div class="ms-auto text-warning">
          <i class="fa fa-star">${item.rating.rate}</i>
        </div>
      </div>
    </div>
    <div class="card-footer d-flex justify-content-between align-items-center pb-2 mb-1">
